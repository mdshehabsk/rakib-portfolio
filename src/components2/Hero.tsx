...
const SLIDES: Slide[] = [
  {
    ...
    descriptionBn:
      "ইসলামিক ক্যালিগ্রাফি, পেইন্টিং, ওয়াল আর্ট, ইন্টেরিয়র ডিজাইন ও ল্যান্ডস্কেপ ডিজাইনের মাধ্যমে আমরা আপনার স্বপ্নকে রূপ দেই শিল্পের ছোঁয়ায়।",
  },
  {
    id: "slide-2",
    image:
  ...
  },
  {
    id: "slide-3",
    image:
      "https://images.unsplash.com/photo-1618221639840-cf1a6805e2f6?q=80&w=1920&auto=format&fit=crop",
    eyebrowBn: "ARTOVA",
  ...
  return (
    ...
    >
      <Swiper
        ...
        className="h-[560px] sm:h-[600px] md:h-[640px] lg:h-[680px]"
      >
        {SLIDES.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className="relative h-full w-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#0a1128]/95 via-[#0a1128]/70 to-[#0a1128]/20" />
